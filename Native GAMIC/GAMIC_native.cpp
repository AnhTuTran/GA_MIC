...
//     vslNewStream(&rnStream, VSL_BRNG_MT2203, time(0));
//     vsRngUniform(VSL_RNG_METHOD_UNIFORM_STD, rnStream, 1, &A, s, d);
// }
int my_parallel_rand (int s, int d) {
...
// Launch  init
    ...
    VSLStreamStatePtr rnStream;
    vslNewStream(&rnStream, VSL_BRNG_MT2203, time(0));
    vsRngUniform(VSL_RNG_METHOD_UNIFORM_STD, rnStream, numTask*sizePop, mang_NST, 0, numMachine - 1);
